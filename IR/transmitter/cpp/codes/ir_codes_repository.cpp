...
char* codeNames[NUMBER_OF_CODES] = { CodeNameOnOff, CodeNameSonyForward };
int codeCounts[NUMBER_OF_CODES] = { CodeSizeOnOff, CodeSizeSonyForward };
int* codeTimes[NUMBER_OF_CODES]{ CodeTimesOnOff, CodeTimesSonyForward };
char* codeValues[NUMBER_OF_CODES]{ CodeValuesOnOff, CodeValuesSonyForward };
