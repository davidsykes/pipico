...
int PicoHardwareInterface::wait_pins_change(PinsChangeData& pinsChangeData, uint64_t timeout)
{
    PINS_CHANGE_DATA pcd;

    hardware_interface->wait_pins_change(&pcd, timeout);
